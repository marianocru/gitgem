...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { gemset_id: @version.gemset_id, numero_version: @version.numero_version, revision: @version.revision }
    end
  ...
  test "should update version" do
    put :update, id: @version, version: { gemset_id: @version.gemset_id, numero_version: @version.numero_version, revision: @version.revision }
    assert_redirected_to version_path(assigns(:version))
  end
