...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { descripcion: @proyecto.descripcion, nombre: @proyecto.nombre, usuario_id: @proyecto.usuario_id }
    end
  ...
  test "should update proyecto" do
    put :update, id: @proyecto, proyecto: { descripcion: @proyecto.descripcion, nombre: @proyecto.nombre, usuario_id: @proyecto.usuario_id }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
